...
const renderContent = {
    1 : (
        <h1 className='sm:text-xl sm:leading-snug text-center neo-brutalism-blue py-4 px-8 text-white mx-5'>
            Hi, I'm <span className='font-semibold'>Sagar</span> 👋🏻<br />
            A Software Engineer from India
            
        </h1>
    ),
    2 : (
        <InfoBox  text={"Worked with many companys as Intern and picked up many skills along the way."} link={"/about"} btnText={"Learn more"}/>
    ),
    3 : (
